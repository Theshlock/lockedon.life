...
window.onkeydown = function(event) {
    ...
    if(keyPr === 39){
        xnorm += ( 50 / zoom ); //right arrow
    }
    else if(keyPr === 37){
        xnorm -= ( 50 / zoom ); //left arrow
    }
    else if(keyPr === 38) {
        ynorm -= ( 50 / zoom ); //top arrow
    }
    else if(keyPr === 40){
        ynorm += ( 50 / zoom ); //down arrow
    }
};
...
function gameloop() {
	...
	var portalX = -0.36458333426465594;
	var portalY = -0.6409672115308542;
	//var portalX = 0;
	//var portalY = -1;
	//contextM.fillRect( ( 400 ) + ( zoom / 2 ) - (xnorm * zoom / 2), 300 , 20, 20);
	//contextM.fillRect( ( 800 + zoom * ( 1 - xnorm ) ) / 2, 300 , 20, 20);
	//contextM.fillRect( ( 400 ) + zoom * ( chosenXCoord - xnorm ) / 2, , 20, 20);
	contextM.fillRect( 0.5 * (800 + (zoom*portalX) - (zoom*xnorm)), .5 * (600 + (zoom*portalY) - (zoom*ynorm)) , 20, 20);
        zoom += Math.ceil( zoom / 200 );
        if( zoom > maxZoom )
        zoom = maxZoom;
        zooming = 1;
        zoomTime = performance.now();
