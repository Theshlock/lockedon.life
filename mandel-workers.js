...
//factor offset!
		...
		contextM.fillStyle = 'green';
		console.log(((xnorm - portalX)*zoom)/1600); // x distance from origin as a factor of screen width
		console.log(((ynorm - portalY)*zoom)/1200); // x distance from origin as a factor of screen width
		console.log( ( ( 400 -  ((portalX-xnorm) * zoom + 800) / 2 )**2 + (300 - ((portalY-ynorm) * zoom + 600) / 2 )**2)**0.5);
